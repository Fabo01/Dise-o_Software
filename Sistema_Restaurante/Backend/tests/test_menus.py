...
def existe_menu(nombre, db):
    MenuModelo.objects.create(nombre=nombre, categoria="General", precio=5000, descripcion="Menu de prueba")
    assert MenuModelo.objects.filter(nombre=nombre).exists()

@given('que existen menús registrados')
def existen_menus_registrados(db):
    MenuModelo.objects.create(nombre="Menú 1", categoria="General", precio=5000, descripcion="Menu 1")
    MenuModelo.objects.create(nombre="Menú 2", categoria="General", precio=6000, descripcion="Menu 2")
...
def crear_menu(nombre, categoria, db):
    MenuModelo.objects.create(nombre=nombre, categoria=categoria, precio=5000, descripcion="Menu de prueba")
